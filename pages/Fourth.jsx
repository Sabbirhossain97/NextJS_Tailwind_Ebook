                                        ...
                                        <div class="pt-6" id="filter-section-mobile-0">
                                            <div class="space-y-6">
                                                <div class="flex items-center">
                                                    <input id="filter-mobile-color-0" name="color[]" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                    <label for="filter-mobile-color-0" class="ml-3 min-w-0 flex-1 text-gray-500">Humayun Ahmed</label>
                                                </div>

                                                <div class="flex items-center">
                                                    <input id="filter-mobile-color-1" name="color[]" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                    <label for="filter-mobile-color-1" class="ml-3 min-w-0 flex-1 text-gray-500">Jafor Iqbal</label>
                                                </div>

                                                <div class="flex items-center">
                                                    <input id="filter-mobile-color-2" name="color[]" type="checkbox" checked class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                    <label for="filter-mobile-color-2" class="ml-3 min-w-0 flex-1 text-gray-500">Satyajit Roy</label>
                                                </div>

                                                {/* <div class="flex items-center">
                                                    <input id="filter-mobile-color-3" name="color[]"  type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                    <label for="filter-mobile-color-3" class="ml-3 min-w-0 flex-1 text-gray-500">Brown</label>
                                                </div>

                                                <div class="flex items-center">
                                                    <input id="filter-mobile-color-4" name="color[]"  type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                    <label for="filter-mobile-color-4" class="ml-3 min-w-0 flex-1 text-gray-500">Green</label>
                                                </div>

                                                <div class="flex items-center">
                                                    <input id="filter-mobile-color-5" name="color[]"  type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        ...
                                        <div class="pt-6" id="filter-section-mobile-1">
                                            <div class="space-y-6">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-mobile-category-0" class="ml-3 min-w-0 flex-1 text-gray-500">Mystery</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-mobile-category-1" class="ml-3 min-w-0 flex-1 text-gray-500">Horror</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-mobile-category-2" class="ml-3 min-w-0 flex-1 text-gray-500">Sci-fi</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-mobile-category-3" class="ml-3 min-w-0 flex-1 text-gray-500">Detective</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-mobile-category-4" class="ml-3 min-w-0 flex-1 text-gray-500">Novel</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pt-6" id="filter-section-0">
                                            <div class="space-y-4">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-color-0" class="ml-3 text-sm text-gray-600">Humayun Ahmed</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-color-1" class="ml-3 text-sm text-gray-600">Jafor iqbal</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-color-2" class="ml-3 text-sm text-gray-600">Satyajit Roy</label>
                                                </div>
                                        ...
                                        <div class="pt-6" id="filter-section-1">
                                            <div class="space-y-4">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-category-0" class="ml-3 text-sm text-gray-600">Mystery</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-category-1" class="ml-3 text-sm text-gray-600">Horror</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-category-2" class="ml-3 text-sm text-gray-600">Sci-fi</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-category-3" class="ml-3 text-sm text-gray-600">Detective</label>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="filter-category-4" class="ml-3 text-sm text-gray-600">Novel</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
